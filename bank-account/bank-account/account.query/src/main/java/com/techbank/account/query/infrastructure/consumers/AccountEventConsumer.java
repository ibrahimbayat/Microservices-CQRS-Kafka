...
public class AccountEventConsumer implements EventConsumer{
    ...
    @Autowired
    private EventHandler eventHandler; //db işini yapan yer

    @KafkaListener(topics="AccountOpenedEvent",groupId="${spring.kafka.consumer.group-id}") //turns method into kafka consumer
    @Override
